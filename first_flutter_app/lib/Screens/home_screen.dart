import 
'package:first_flutter_app/Screens/add_product_screen.dart'; 
import 
'package:first_flutter_app/Screens/edit_product_screen.dart'; 
import 
...
Key(snapshot.data!.docs[index].id), 
 onDismissed: (direction) {  firebaseService.col 
